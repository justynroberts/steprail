...
export const TOOL_CORE = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'host', label: 'Host(s)', kind: 'code', placeholder: 'web1.example.com, web2.example.com, deploy@web3:2222 — a comma list runs on every host in parallel. An SSH secret named like a host is used for it automatically.', required: true, tab: 'Target' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'invSource', label: 'Inventory source', kind: 'select', options: ['inline', 'git'], tab: 'Inventory' },
