...
import { BarChart2, GraduationCap, KeySquare, LayoutTemplate, Moon, Server, Settings2, ShieldCheck, Sliders, Sun, Workflow } from 'lucide-react'
import type { Project, Settings } from '../types'
import { Logo } from './Logo'
import { ProjectSwitcher } from './ProjectSwitcher'

export type AppView = 'flows' | 'blueprints' | 'infrastructure' | 'approvals' | 'config' | 'secrets' | 'reports' | 'setup' | 'editor'
